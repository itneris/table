...
2. **filters: arrayOf([Filter](#Filter))** — начальная фильтрация таблицы
...
14. **stickyHeader: bool** - если true, то шапка таблицы при вертикальной прокрутке будет оставаться на месте, по умолчанию _false_
15. **small: bool** - paddingTop и paddingBottom у строк становятся меньше, по умолчанию _false_
16. **stripedRows: bool** - чередует цвет строк таблицы, по умолчанию _false_
...
22. **customToolbar: React.Element** — дополнительная строка с действиями грида, которая отобразится справа перед фильтрами
## Methods
